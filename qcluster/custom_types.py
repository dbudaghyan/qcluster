...
DissimilarityFunctionType = Callable[
    [list[Union[str, EmbeddingType]], int], list[tuple[int, Union[str, EmbeddingType]]]
]
SimilarityFunctionType = Callable[
    [Union[str, EmbeddingType], list[Union[str, EmbeddingType]], int],
